# Generated by Django 5.0.8 on 2025-08-23 16:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('initial_password', models.CharField(blank=True, max_length=20)),
                ('password_changed', models.BooleanField(default=False)),
                ('password_changed_at', models.DateTimeField(blank=True, null=True)),
                ('must_change_password', models.BooleanField(default=True)),
                ('is_enabled', models.BooleanField(default=True)),
                ('batch_year', models.IntegerField(blank=True, choices=[(2079, '2079'), (2080, '2080'), (2081, '2081'), (2082, '2082'), (2083, '2083'), (2084, '2084'), (2085, '2085'), (2086, '2086'), (2087, '2087'), (2088, '2088'), (2089, '2089')], null=True)),
        ...
        migrations.AddIndex(
            model_name='user',
            index=models.Index(fields=['batch_year'], name='accounts_us_batch_y_2f28c3_idx'),
        ),
        migrations.AddIndex(
            model_name='user',
            index=models.Index(fields=['password_changed'], name='accounts_us_passwor_ccad9f_idx'),
        ),
    ]
