...
def my_analytics(request):
    """Student view of their own analytics"""
...
def student_stress_detail(request, student_id):
    ...
    # Get comprehensive stress data
    latest_stress = StressCalculator.get_latest_stress_level(student)
...
def admin_view_all_logsheets(request):
    ...
    # Get high stress students (stress level > 70)
    ...
    avg_stress = StressLevel.objects.aggregate(Avg('level'))['level__avg']
